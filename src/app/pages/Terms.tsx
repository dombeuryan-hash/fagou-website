...
export default function Terms() {
  ...
  const articles = [
    ...
    {
      fr: "Les obligations réciproques de l'acheteur et de FAGOU SRL sont régies par celui des Incoterms 2000 mentionné dans nos contrats, factures et offres.",
      en: "The reciprocal obligations of the buyer and FAGOU SRL are governed by the Incoterms 2000 mentioned in our contracts, invoices and offers.",
    },
    {
      fr: "L'expédition, qui peut se faire de façon fractionnée, s'effectue aux risques et périls ainsi qu'aux frais de l'acheteur. Même lorsque l'assurance est souscrite par FAGOU SRL au bénéfice de l'acheteur, FAGOU SRL ne supporte pas les risques de pertes ou de dommages postérieurs à la livraison, même pour ce qui concerne la franchise éventuelle. L'acheteur effectuera toutes les formalités en vue d'obtenir réparation à charge des assureurs.",
      en: "Shipment, which may be made in instalments, is carried out at the buyer's risk and expense. Even when insurance is taken out by FAGOU SRL for the benefit of the buyer, FAGOU SRL does not bear the risks of loss or damage after delivery, including with regard to any deductible. The buyer shall carry out all formalities in order to obtain compensation from the insurers.",
    },
    {
    ...
    {
      fr: "L'acheteur doit examiner les marchandises ou les faire examiner dans un délai aussi bref que possible eu égard aux circonstances. Si FAGOU SRL ne doit pas, selon l'Incoterm choisi, conclure le contrat de transport, l'acheteur doit procéder ou faire procéder à l'examen des marchandises avant le transport. Si l'Incoterm choisi implique que FAGOU SRL doit conclure le contrat pour le transport de la marchandise, l'examen de celle-ci peut être différé jusqu'à son arrivée à destination. L'acheteur est déchu du droit de se prévaloir d'un éventuel défaut de conformité s'il ne l'a pas dénoncé à FAGOU SRL, en précisant la nature de ce défaut, dans un délai de 48 heures après l'expiration du délai prévu ci-dessus pour l'examen de la marchandise.",
      en: "The buyer must inspect the goods or have them inspected as promptly as possible given the circumstances. If FAGOU SRL is not required, under the chosen Incoterm, to conclude the contract of carriage, the buyer must inspect or have the goods inspected before transport. If the chosen Incoterm requires FAGOU SRL to conclude the contract for the carriage of the goods, the inspection may be deferred until arrival at destination. The buyer forfeits the right to invoke any lack of conformity if they have not notified FAGOU SRL of it, specifying the nature of the defect, within 48 hours after the expiry of the period provided above for inspection of the goods.",
    },
    {
    ...
    {
      fr: "Au cas où nous résilierions le contrat pour les motifs précités, FAGOU SRL est tenus d'en informer l'acheteur par télécopie, ou pdf document envoyé par e-mail, ou lettre, sans qu'aucune autre formalité ne soit nécessaire.",
      en: "Should we terminate the contract for the aforementioned reasons, FAGOU SRL is required to inform the buyer by fax, or pdf document sent by e-mail, or letter, without any other formality being required.",
    },
    {
