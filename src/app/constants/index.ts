...
export const COMPANY_PHONE = '+32 2 XXX XX XX'
export const COMPANY_ADDRESS = 'Bruxelles, Belgique'
export const COMPANY_ADDRESS_FULL = 'Rue de la Loi 1, 1000 Bruxelles, Belgique'
