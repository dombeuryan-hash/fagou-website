...
export const COMPANY_ADDRESS = 'Rhode-Saint-Genèse, Belgique'
export const COMPANY_ADDRESS_FULL = 'Chaussée de Waterloo 198-200, 1640 Rhode-Saint-Genèse, Belgique'
